...
public class Commande {
	...
	public Commande(double montantCommande, int qteEntree, int qtePlat, int qteDessert, int qteBoisson, User employee,
	...
	public String toString() {
		return "Commande [idCommande=" + idCommande + ", montantCommande=" + montantCommande + ", qteEntree="
				+ qteEntree + ", qtePlat=" + qtePlat + ", qteDessert=" + qteDessert + ", qteBoisson=" + qteBoisson
				+ ", employee=" + employee + ", plat=" + plat + ", entree=" + entree + ", dessert=" + dessert
				+ ", boisson=" + boisson + "]";
	}
